...
# Choose visibility or discoverability options for MSIX app
...
The selections in the **Discoverability** section indicate how customers can discover and acquire your app. Note that Discoverability works together with Schedule. Your product is discovearble after its scheduled date. See [Base schedule and Release](./schedule-pricing-changes.md#base-schedule) for more details
