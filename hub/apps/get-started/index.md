...
> [!TIP]
> If you've already invested in WPF, you can continue to use it and take advantage of the modernization options in .NET 9. You can build your apps knowing that Microsoft is continuing to invest in WPF. See [Client app development framework FAQ](client-frameworks-faq.yml) for more information.
