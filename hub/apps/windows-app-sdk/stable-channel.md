...
- Fixed an install-time failure creating ApplicationData's Machine folder if an expected parent directory was missing.
- Fixed an issue handling `<accesscontrol:AccessControl>` in AppxManifest.xml.
